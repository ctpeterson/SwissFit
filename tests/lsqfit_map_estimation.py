...
if __name__ == '__main__':
    ...
    # Create optimizer object (for local optimization with TRF)
    ...
    """ Do fit with Lsqfit """
    # Do fit with Peter Lepage's Lsqfit
    fit = lsqfit.nonlinear_fit(data = (data['x'], data['y']), fcn = sin, prior = prior)
