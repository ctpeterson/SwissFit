...
`SwissFit` currently supports the following.
  ...
  - Bayesian model averaging in the flavor of [PRD103(2021)114502](https://journals.aps.org/prd/abstract/10.1103/PhysRevD.103.114502) and [PRD109(2024)014510](https://journals.aps.org/prd/abstract/10.1103/PhysRevD.109.014510). All model-averaged parameters returned by SwissFit are correlated! See example the example below and under `examples/model_average_correlation_function.py`.
